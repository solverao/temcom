<x-temcom::navbar>
    ...
    <x-slot:navigationLinks>
        @each('temcom::partials.navigation-menu.nav-link-item', $temcom->menu('sidebar'), 'item')
    </x-slot:navigationLinks>
        ...
        <div class="ms-3 relative">
            <x-temcom::dropdown align="right" width="48">
                ...
                <x-slot name="content">
                    ...
                    @each('temcom::partials.navigation-menu.dropdown-link-item', $temcom->menu('account_dropdown'),
                    'item')
    ...
    <x-slot:responsiveNavigationLinks>
        <div class="pt-2 pb-3 space-y-1">
            @each('temcom::partials.navigation-menu.responsive-nav-link-item', $temcom->menu('sidebar'), 'item')
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                $temcom->menu('account_dropdown'),'item')
...
{{-- <nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="ms-3 relative">
                    <x-temcom::dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @each('temcom::partials.navigation-menu.dropdown-link-item',
                            $temcom->menu('account_dropdown'), 'item')
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                @each('temcom::partials.navigation-menu.responsive-nav-link-item', $temcom->menu('account_dropdown'),
                'item')
