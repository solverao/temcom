<x-temcom::header>
    ...
    <x-slot:itemsLeft>
        ...
        <div class="relative">
            <div class="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-3.5">
                @svg('fas-search','shrink-0 size-4 text-gray-400 dark:text-white/60')
            </div>
            <input type="text"
    ...
    <x-slot:itemsRight>
        ...
        <x-temcom::header.circular-button icon="fas-search" class="md:hidden">Search</x-temcom::header.circular-button>
        ...
        <x-temcom::header.dropdown
            img="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80"
            alt="img">
            <x-slot:header>
            ...
            <x-temcom::header.dropdown-link icon="fas-bell">Newslater</x-temcom::header.dropdown-link>
        </x-temcom::header.dropdown>
